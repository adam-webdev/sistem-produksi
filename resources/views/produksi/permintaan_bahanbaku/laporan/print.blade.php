...
<body>
    ...
    <div class="row">
        <h5 class="text-center">
            {{ $periode == 'all'? 'Laporan Permintaan bahan baku produksi all ': 'Laporan  Permintaan bahan baku  produksi Per-periode ' . $tgl_awal . ' sampai dengan ' . $tgl_akhir . '.' }}
        </h5>
    </div>
                ...
                @foreach ($data as $r)
                    <tr>
                        ...
                        @if ($r->status === 'Permintaan Diterima')
                            <td><span class="btn btn-sm btn-light shadow-lg text-success">Permintaan Diterima</span></td>
                        @else
                            <td>
